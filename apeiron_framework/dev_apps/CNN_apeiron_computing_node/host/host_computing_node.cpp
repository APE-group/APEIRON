...
int main(int argc, char** argv)
{
  ...
  //      std::getchar();
	...
	//free(rings);
		...
		//xrt::kernel ktopnnet1(device, uuid, "top_nnet:{top_nnet_1}");
		//xrt::kernel ktopnnet2(device, uuid, "top_nnet:{top_nnet_2}");
		//xrt::kernel ktopnnet3(device, uuid, "top_nnet:{top_nnet_3}");
		//xrt::kernel ktopnnet4(device, uuid, "top_nnet:{top_nnet_4}");
		std::printf("TOP_NNET IPs done\n");
		std::printf("Resetting switch\n");	
		//xrt::kernel kreceiver(device, uuid, "krnl_receiver:{krnl_receiver_1}");
		...
		//xrt::run ktopnnet1_run = ktopnnet1(0);
		//xrt::run ktopnnet2_run = ktopnnet2(0);
		//xrt::run ktopnnet3_run = ktopnnet3(0);
		//xrt::run ktopnnet4_run = xrt::run(ktopnnet4);
		
		//ktopnnet1.write_register(16, 0);
		//ktopnnet2.write_register(16, 1);
		//ktopnnet4_run.set_arg(0, 2);
