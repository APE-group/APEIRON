...
#include "weights/100kHz_10ns_weights_TP_3/w2.h"
#include "weights/100kHz_10ns_weights_TP_3/b2.h"
#include "weights/100kHz_10ns_weights_TP_3/w5.h"
#include "weights/100kHz_10ns_weights_TP_3/b5.h"
#include "weights/100kHz_10ns_weights_TP_3/w8.h"
#include "weights/100kHz_10ns_weights_TP_3/b8.h"
...
extern "C" void hwfunc4(
    ...
    if (!loaded_weights) {
        nnet::load_weights_from_txt<weight2_t, 800>(w2, "100kHz_10ns_weights_TP_3/w2.txt");
        nnet::load_weights_from_txt<bias2_t, 20>(b2, "100kHz_10ns_weights_TP_3/b2.txt");
        nnet::load_weights_from_txt<weight5_t, 320>(w5, "100kHz_10ns_weights_TP_3/w5.txt");
        nnet::load_weights_from_txt<bias5_t, 16>(b5, "100kHz_10ns_weights_TP_3/b5.txt");
        nnet::load_weights_from_txt<weight8_t, 64>(w8, "100kHz_10ns_weights_TP_3/w8.txt");
        nnet::load_weights_from_txt<bias8_t, 4>(b8, "100kHz_10ns_weights_TP_3/b8.txt");
        loaded_weights = true;    }
#endif
    // ****************************************
    ...
    #pragma HLS STREAM variable=layer2_out depth=1000
    nnet::dense<input_t, sector_fc4_5_result_t, config2>(input_310, layer2_out, w2, b2); // sector_fc4_5

    hls::stream<layer4_t> layer4_out("layer4_out");
    #pragma HLS STREAM variable=layer4_out depth=1000
    ...
    #pragma HLS STREAM variable=layer8_out depth=1000
...
extern "C" void top_TP_block_4( int coord, unsigned ch_id, unsigned task_id, bool start,
...
#pragma HLS dataflow
   ...
   #pragma HLS stream variable=mlp_dam_output0 depth=100
    	...
    	hwfunc4(mlp_dam_input0, mlp_dam_output0);
