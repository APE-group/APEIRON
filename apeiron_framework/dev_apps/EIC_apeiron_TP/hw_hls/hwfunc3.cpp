...
#include "weights/100kHz_10ns_weights_TP_2/w2.h"
#include "weights/100kHz_10ns_weights_TP_2/b2.h"
#include "weights/100kHz_10ns_weights_TP_2/w5.h"
#include "weights/100kHz_10ns_weights_TP_2/b5.h"
#include "weights/100kHz_10ns_weights_TP_2/w8.h"
#include "weights/100kHz_10ns_weights_TP_2/b8.h"
...
extern "C" void hwfunc3(
    ...
    if (!loaded_weights) {
        nnet::load_weights_from_txt<weight2_t, 800>(w2, "100kHz_10ns_weights_TP_2/w2.txt");
        nnet::load_weights_from_txt<bias2_t, 20>(b2, "100kHz_10ns_weights_TP_2/b2.txt");
        nnet::load_weights_from_txt<weight5_t, 320>(w5, "100kHz_10ns_weights_TP_2/w5.txt");
        nnet::load_weights_from_txt<bias5_t, 16>(b5, "100kHz_10ns_weights_TP_2/b5.txt");
        nnet::load_weights_from_txt<weight8_t, 64>(w8, "100kHz_10ns_weights_TP_2/w8.txt");
        nnet::load_weights_from_txt<bias8_t, 4>(b8, "100kHz_10ns_weights_TP_2/b8.txt");
        loaded_weights = true;    }
#endif
    // ****************************************
...
extern "C" void top_TP_block_3( int coord, unsigned ch_id, unsigned task_id, bool start,
...
#pragma HLS dataflow
   ...
   #pragma HLS stream variable=mlp_dam_output0 depth=100
    	...
    	hwfunc3(mlp_dam_input0, mlp_dam_output0);
