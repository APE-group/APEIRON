...
extern "C" void hwfunc6(
    ...
    if (!loaded_weights) {
        nnet::load_weights_from_txt<weight2_t, 800>(w2, "100kHz_10ns_weights_TP_5/w2.txt");
        nnet::load_weights_from_txt<bias2_t, 20>(b2, "100kHz_10ns_weights_TP_5/b2.txt");
        nnet::load_weights_from_txt<weight5_t, 320>(w5, "100kHz_10ns_weights_TP_5/w5.txt");
        nnet::load_weights_from_txt<bias5_t, 16>(b5, "100kHz_10ns_weights_TP_5/b5.txt");
        nnet::load_weights_from_txt<weight8_t, 64>(w8, "100kHz_10ns_weights_TP_5/w8.txt");
        nnet::load_weights_from_txt<bias8_t, 4>(b8, "100kHz_10ns_weights_TP_5/b8.txt");
        loaded_weights = true;    }
#endif
    // ****************************************
...
extern "C" void top_TP_block_6( int coord, unsigned ch_id, unsigned task_id, bool start,
...
#pragma HLS dataflow
   ...
   #pragma HLS stream variable=mlp_dam_output0 depth=100
    	...
    	hwfunc6(mlp_dam_input0, mlp_dam_output0);
